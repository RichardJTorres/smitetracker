...
class SmiteClient:
    ...
    def _create_session(self):
        ...
        url = '{0}/createsessionJson/{1}/{2}/{3}'.format(SmiteClient._BASE_URL, self.dev_id, signature,
                                                         self._create_now_timestamp())
    ...
    def _create_signature(self, methodname):
        ...
        return hashlib.md5((self.dev_id + methodname + self.auth_key + now).encode('utf-8')).hexdigest()
    ...
    def _test_session(self, session):
        ...
        return "successful" in requests.get(url).text
